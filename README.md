...
To add your new project to its Github repository, firstly make sure you have created a project named **2025-advent-of-code** on Github.
Follow these steps to push your new project.

```
git remote add origin git@github.com:Candl3z/2025-advent-of-code.git
git branch -M main
...
Created by [Parker](https://github.com/Candl3z)
